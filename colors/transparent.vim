...
hi StatusLine	cterm=NONE	ctermfg=magenta	ctermbg=NONE		gui=bold	guifg=White	guibg=Black
hi StatusLineNC	cterm=NONE	ctermfg=magenta	ctermbg=NONE		gui=NONE	guifg=DarkGray	guibg=Black
if version >= 700
